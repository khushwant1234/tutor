...
export default function NotificationsPage() {
  ...
  const getNotificationIcon = (type: string) => {
    switch (type) {
      case 'class_added':
        return <div className="bg-blue-100 p-3 rounded-full"><Clock className="h-5 w-5 text-blue-600" /></div>;
      case 'class_reminder': 
        return <div className="bg-amber-100 p-3 rounded-full"><Clock className="h-5 w-5 text-amber-600" /></div>;
      default:
        return <div className="bg-gray-100 p-3 rounded-full"><BellIcon className="h-5 w-5 text-gray-600" /></div>;
    }
  };
